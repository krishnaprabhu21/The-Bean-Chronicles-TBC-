...
const ROAST_OPTIONS = [
  {
    ...
    label: "Light Roast",
    emoji: "☀️",
    desc: "Just a quick question",
  },
  {
    value: "medium",
    label: "Medium Roast",
    emoji: "☕",
    desc: "A proper conversation",
  },
  {
    value: "dark",
    label: "Dark Roast",
        ...
        >
          ...
          <div className="relative">
            <svg width="72" height="72" viewBox="0 0 64 64" fill="none">
              ...
              />
              <path
                d="M56 24 Q66 24 66 32 Q66 40 56 40"
                stroke="#C9A84C"
                strokeWidth="1.5"
                strokeLinecap="round"
                fill="none"
              ...
              <path
                d="M26 37 Q29 40 32 40 Q35 40 38 37"
                stroke="#C9A84C"
                strokeWidth="1.5"
                strokeLinecap="round"
                fill="none"
          ...
          <div>
            ...
            >
              Your message is steeping nicely. We'll get back to you before your
              cup goes cold.
            </p>
          </div>
          <button
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.color = "rgba(201,168,76,0.45)";
            }}
          >
            Send another ↩
          </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.borderColor = "rgba(80,120,60,0.25)";
                }}
                required
              />
            </div>
...
export default function About() {
  return (
    <div className="min-h-screen pt-24">
      <SEO
        title="About"
        description="The Bean Chronicles — a coffee magazine built for the curious, the caffeinated, and the connoisseur."
      />
      {/* Hero */}
      <section
      ...
      >
        ...
        >
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-7xl mt-3 mb-6 leading-tight" style={{ color: 'var(--color-text)' }}>
            The Bean Chronicles
          </h1>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <img
              src={missionImg}
              alt="Mission image"
              className="rounded-3xl object-cover block mx-auto"
              style={{
                width: "70%",
          ...
          >
            ...
            <h2 className="font-display text-4xl mt-2 mb-6" style={{ color: 'var(--color-text)' }}>
      ...
      <section className="w-full max-w-[1600px] mx-auto px-8 sm:px-14 xl:px-20 py-16 pb-28">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl mt-1" style={{ color: 'var(--color-text)' }}>
            Meet the Team
          </h2>
        </motion.div>
